        ...
        <div class="modal-content">
          <div class="modal-body">
            <div class="column" id="main">
              ...
              <ul>
                <li v-for="review in profile.reviews" :key="review.pk" style="color:black" class="my-2">
                  <!-- 작성자 -->
                  <!-- 글 이동 링크 (제목) -->
                  제목 : <router-link style="color:black; font-family: 'Noto Sans KR', sans-serif;" class="text-decoration-none btn-outline-secondary"
                    :to="{ name: 'review', params: {reviewPk: review.pk} }">
                    {{ review.title }}
                  </router-link>
                  <br>
                  ...
                  <!-- 댓글 개수/좋아요 개수 -->
                  <i class="fa fa-comment" style="color:black"></i>: {{ review.comments.length }}  |  <i class="fa fa-heart" style="color:black"></i> : {{ review.like_users.length }}
        ...
        <div class="modal-content">
          <div class="modal-body">
            <div class="column" id="main">
              ...
              <ul>
                <li v-for="review in profile.like_reviews" :key="review.pk" class="my-2" style="color:black">

                  제목 : <router-link class="text-decoration-none btn-outline-secondary" :to="{ name: 'review', params: { reviewPk: review.pk } }" style="color:black; font-family: 'Noto Sans KR', sans-serif;">
                    {{ review.title }}
                  </router-link>                
                </li>
              </ul>              
            ...
            <div class="column" id="main">
              ...
              <div class="container">
                <main class="page-content d-flex justify-content-center row">
                  <div v-for="movie in profile.like_movies" :key="movie.id" class="card1" :style="{ backgroundImage: 'url(' + `https://image.tmdb.org/t/p/w500${movie.poster_path}` + ')' }">
                    <div class="content">
